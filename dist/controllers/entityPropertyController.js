...
export const getEntityProperties = async (req, res) => {
    try {
        const { entity_type, entity_id, property_definition_id, string_value, page, limit } = req.query;
...
export const createEntityProperty = async (req, res) => {
    try {
        ...
        const { entity_type, entity_id, property_definition_id, value, value_type } = req.body;
