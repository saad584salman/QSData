...
export const createPropertyDefinition = async (req, res) => {
    try {
        ...
        const { entity_type, property_key, value_type, formatting_rules, is_required = false, options = [] } = req.body;
...
export const updatePropertyDefinition = async (req, res) => {
    try {
        ...
        const { id } = req.params;
        const { entity_type, property_key, value_type, formatting_rules, is_required, options = [] } = req.body;
