...
import { PropertyDefinition as PropertyDefinitionType, QueryOptions, ApiResponse, PaginatedResponse } from '../types/index.js';

export const getPropertyDefinitions = async (req: Request, res: Response): Promise<void> => {
  try {
